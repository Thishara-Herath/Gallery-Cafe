...
<head>
	...
	<link href="css/register_staff.css" rel="stylesheet">
</head>
		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="container">
						<form action="staffaction_page.php" method="post" enctype="multipart/form-data">
							<div class="row">
								<div class="col-12">
							...
							<div class="row">
								<div class="col-12">
									<input type="password" id="password" name="password" placeholder="Enter Password" style="width: 100%; box-sizing: border-box; border: 1px solid #ced4da; padding: 8px;">
								</div>
							</div><br>
							<div class="row">
								<div class="col-12">
