                ...
                <div class="container-fluid p-0">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_offer'])) {
                                ...
                                if ($image != "") {
                                    ...
                                    $sql = "UPDATE offers SET title='$title', description='$description', image='$image' WHERE id='$id'";
                                } else {
                                    $sql = "UPDATE offers SET title='$title', description='$description' WHERE id='$id'";
                                }
                        ...
                        alert("Error: ' . $sql . '<br>' . $conn->error . '");
                            ...
                            // Fetch all offers to display in the form
                    ...
                    <div class="col-md-6 mb-4">
                        <form action="edit_offers.php" method="post" enctype="multipart/form-data" class="p-3 border rounded">
                            ...
                            <div class="mb-3">
                                ...
                                <img src="uploads/' . $row["image"] . '" alt="' . $row["title"] . '" class="img-thumbnail mt-2" style="max-width: 200px;">
                            </div>
