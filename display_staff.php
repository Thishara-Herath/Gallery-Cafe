				...
				<div class="container-fluid p-0">
					<div class="container">
						...
						if ($result->num_rows > 0) {
							...
							echo "<thead><tr><th>ID</th><th>First Name</th><th>Last Name</th><th>NIC</th><th>Address</th><th>Mobile Number</th><th>Email</th><th>Profile Picture</th><th>Actions</th></tr></thead>";
							echo "<tbody>";
							...
							while ($row = $result->fetch_assoc()) {
								...
								echo "<td>" . htmlspecialchars($row["mnumber"]) . "</td>";
								echo "<td>" . htmlspecialchars($row["email"]) . "</td>";
								echo "<td>";
								if (!empty($row["profile_picture"])) {
									echo "<img src='" . htmlspecialchars($row["profile_picture"]) . "' alt='Profile Picture' width='50' height='50'>";
								} else {
									echo "No Picture";
								}
								echo "</td>";
								echo "<td><a href='edit_staff.php?id=" . htmlspecialchars($row["id"]) . "' class='btn btn-primary'>Edit</a> <br><br> <a href='delete_staff.php?id=" . htmlspecialchars($row["id"]) . "' class='btn btn-danger'>Delete</a></td>";
								echo "</tr>";
							}
